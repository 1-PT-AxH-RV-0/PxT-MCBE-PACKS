...
- EntityDebugStick：添加了对于实体的调试棒。功能较多，详见[USAGE.md](USAGE.md#entitydebugstick)。
...
- 使用 `make compress` 压缩 ./packs 中的包的代码。
...
- DebugStickUI 和 EntityDebugStick 的 pack\_icon.png 是原版木棍纹理的 64px 版本。
